...
| Nam Hải | Upload video demo lên YouTube, chốt `docs/pitch_deck.pdf` (đổi tên từ `slide.pdf`) làm bản slide chính thức (deliverable #7), xóa 2 bản slide cũ trùng lặp (`presentation/pitch_deck.pdf`, `.pptx`) + 1 file rác Office lock, cập nhật `docs/video-demo.md` với link YouTube thật, bổ sung deliverable #7 vào bảng README | ✅ Done | `docs/video-demo.md`, `docs/pitch_deck.pdf`, `README.md` | - |
