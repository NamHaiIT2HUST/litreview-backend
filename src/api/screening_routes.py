...
from src.models.db_models import Paper, Project, RelevanceBucket, ScreeningDecision, ScreeningHistory
from src.models.screening_schemas import BulkScreeningDecisionRequest, ScreeningDecisionRequest, ScreenResponse
from src.services.screening_service import recompute_priority, screen_paper_ai
...
async def screen_paper(paper_id: str, payload: PaperScreenPayload | None = None, db: AsyncSession = Depends(get_db)):
