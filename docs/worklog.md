# 📋 Worklog — P-165 LitReview Agent

## Thống kê tổng quan

| Chỉ số | Giá trị |
|--------|---------|
| **Thời gian phát triển** | Tháng 7/2026 → Tháng 9/2026 |
| **Tổng số commits** | 491 commits |
| **Contributors** | 4 thành viên |
| **Nhánh chính** | `main` |
| **Repository** | [AI20K-Build-Phase-Cohort-3/P-165](https://github.com/AI20K-Build-Phase-Cohort-3/P-165) |

## Contributors

| Thành viên | GitHub | Vai trò |
|-----------|--------|---------|
| Nguyễn Đình Liêm | [@liemnd4](https://github.com/liemnd4) | Team Lead, Backend |
| Tạ Thị Nga | [@ngatt-17](https://github.com/ngatt-17) | Frontend, UI/UX |
| Nguyễn Văn Hưng | [@lucasvahust](https://github.com/lucasvahust) | Backend, AI Pipeline |
| Nguyễn Đào Nam Hải | [@NamHaiIT2HUST](https://github.com/NamHaiIT2HUST) | Full-stack, Testing |

---

## Git Log (Toàn bộ lịch sử commit)
