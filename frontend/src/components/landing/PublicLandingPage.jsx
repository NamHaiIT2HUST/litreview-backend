  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#080E1A] text-surface-900 dark:text-surface-100 font-sans selection:bg-primary-500 selection:text-white transition-colors relative overflow-hidden">
      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 transition-colors shadow-2xs">
        <div className="max-w-[1680px] mx-auto px-3 sm:px-6 lg:px-8 h-18 sm:h-20 flex items-center justify-between gap-3 lg:gap-6 relative z-10">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden xl:flex items-center gap-3.5 2xl:gap-5 text-xs xl:text-[13.5px] font-bold text-slate-700 dark:text-slate-200 whitespace-nowrap">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0">
            ...
            <button
              ...
              className="px-2.5 sm:px-3 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all text-xs font-bold flex items-center gap-1.5 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 cursor-pointer shadow-2xs shrink-0"
            ...
            <button
              ...
              className="p-2 sm:p-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all text-slate-600 dark:text-slate-300 border border-slate-200 dark:border-slate-700 cursor-pointer shadow-2xs shrink-0"
            ...
            <button
              ...
              className="btn btn-secondary px-3.5 sm:px-4 py-2 text-xs sm:text-sm font-bold cursor-pointer shrink-0 whitespace-nowrap"
            >
              {d.nav.login}
            </button>
            ...
            <button
              ...
              className="btn btn-primary px-4 sm:px-5 py-2 text-xs sm:text-sm font-bold shadow-md shadow-blue-500/20 inline-flex items-center gap-1.5 cursor-pointer hover:scale-105 transition-all shrink-0 whitespace-nowrap"
            >
