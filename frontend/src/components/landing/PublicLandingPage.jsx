...
export default function PublicLandingPage({ onOpenAuth }) {
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#080E1A] text-surface-900 dark:text-surface-100 font-sans selection:bg-primary-500 selection:text-white transition-colors relative overflow-x-hidden w-full">
      ...
      {/* ── 0. Floating Scrollytelling Side Indicator (2XL Desktop Only to prevent overlap) ───── */}
      <div className="hidden 2xl:flex fixed right-3 top-1/2 -translate-y-1/2 z-40 flex-col items-end gap-2.5 pointer-events-auto">
        {[
      ...
      <header className="sticky top-0 z-50 bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl border-b border-slate-200/80 dark:border-slate-800/80 transition-colors shadow-2xs w-full">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-18 sm:h-20 flex items-center justify-between gap-3 lg:gap-4 relative z-10 w-full">
          ...
          {/* Desktop Nav Links */}
          <nav className="hidden xl:flex items-center gap-2.5 2xl:gap-4 text-xs xl:text-[13px] font-bold text-slate-700 dark:text-slate-200 whitespace-nowrap">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            <button
              ...
              className="px-2 sm:px-2.5 py-1.5 sm:py-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all text-xs font-bold flex items-center gap-1 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 cursor-pointer shadow-2xs shrink-0"
            ...
            <button
              ...
              className="btn btn-secondary px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-bold cursor-pointer shrink-0 whitespace-nowrap"
            >
              {d.nav.login}
            </button>
